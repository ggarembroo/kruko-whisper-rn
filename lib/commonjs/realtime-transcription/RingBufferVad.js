...
class RingBufferVad {
  ...
  chunkAccumulated = 0;
  accumulatedChunks = [];
  constructor(vadContext, options = {}) {
    ...
    this.ringBuffer = new _RingBuffer.RingBuffer(bufferSize);
      ...
      this.vadInferenceQueue.push(async () => {
        ...
        try {
          ...
          if (vadInput.byteLength > 0) {
            ...
            // t0/t1 is 10ms unit
            speechRate = segments.reduce((acc, {
              t0,
              t1
            }) => acc + (t1 - t0) / 100, 0) / audioLength;
            lastSpeechOffset = segments.length > 0 ? segments[segments.length - 1].t1 * 10 : -1;
          }
        } catch (error) {
          var _this$errorCallback;
          this.log(`VAD error: ${error}`);
          (_this$errorCallback = this.errorCallback) === null || _this$errorCallback === void 0 || _this$errorCallback.call(this, `VAD processing error: ${error.message || error}`);
          resolve();
          return;
        }
  ...
  async handleVadStateChange(lastSpeechOffset, speechRate, vadContextData, newChunkData) {
    ...
    if (speechRate > this.options.speechRateThreshold) {
      ...
      if (!this.isSpeechActive) {
        ...
        (_this$speechDetectedC = this.speechDetectedCallback) === null || _this$speechDetectedC === void 0 || _this$speechDetectedC.call(this, speechRate, vadContextData);
      } else {
        ...
        if (currentDurationMs > maxDurationS * 1000) {
          ...
          this.isSpeechActive = false;
          (_this$speechEndedCall = this.speechEndedCallback) === null || _this$speechEndedCall === void 0 || _this$speechEndedCall.call(this, 1.0);

          // Immediately restart
          this.isSpeechActive = true;
          this.currentSpeechStartTime = Date.now();
          (_this$speechDetectedC2 = this.speechDetectedCallback) === null || _this$speechDetectedC2 === void 0 || _this$speechDetectedC2.call(this, speechRate, vadContextData);
        } else {
          var _this$speechContinueC;
          // Speech Continue
          (_this$speechContinueC = this.speechContinueCallback) === null || _this$speechContinueC === void 0 || _this$speechContinueC.call(this, speechRate, newChunkData);
        }
      }
      ...
      if (silenceDuration > minSilenceDurationMs / 1000) {
        ...
        this.isSpeechActive = false;
        this.silenceStartTime = 0;
        (_this$speechEndedCall2 = this.speechEndedCallback) === null || _this$speechEndedCall2 === void 0 || _this$speechEndedCall2.call(this, 1 - speechRate);
      }
    } else if (this.isSpeechActive) {
      var _this$speechContinueC2;
      // Emit continue to keep recording during silence/gaps
      (_this$speechContinueC2 = this.speechContinueCallback) === null || _this$speechContinueC2 === void 0 || _this$speechContinueC2.call(this, speechRate, newChunkData);
    }
  }
  log(message) {
    var _this$options$logger, _this$options;
    (_this$options$logger = (_this$options = this.options).logger) === null || _this$options$logger === void 0 || _this$options$logger.call(_this$options, `[RingBufferVad] ${message}`);
  }
...
exports.RingBufferVad = RingBufferVad;
