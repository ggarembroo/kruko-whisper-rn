...
export class SimulateFileAudioStreamAdapter {
  ...
  async initialize(config) {
    ...
    try {
      ...
      (_this$errorCallback = this.errorCallback) === null || _this$errorCallback === void 0 || _this$errorCallback.call(this, errorMessage);
  ...
  async start() {
    ...
    try {
      ...
      (_this$statusCallback = this.statusCallback) === null || _this$statusCallback === void 0 || _this$statusCallback.call(this, true);
      ...
      (_this$statusCallback2 = this.statusCallback) === null || _this$statusCallback2 === void 0 || _this$statusCallback2.call(this, false);
      const errorMessage = error instanceof Error ? error.message : 'Unknown start error';
      (_this$errorCallback2 = this.errorCallback) === null || _this$errorCallback2 === void 0 || _this$errorCallback2.call(this, errorMessage);
      throw error;
    }
  }
  async stop() {
    ...
    try {
      ...
      (_this$statusCallback3 = this.statusCallback) === null || _this$statusCallback3 === void 0 || _this$statusCallback3.call(this, false);
      ...
      (_this$errorCallback3 = this.errorCallback) === null || _this$errorCallback3 === void 0 || _this$errorCallback3.call(this, errorMessage);
    }
  }
  isRecording() {
  ...
  startStreaming() {
    ...
    if (!header) {
      ...
      (_this$errorCallback4 = this.errorCallback) === null || _this$errorCallback4 === void 0 || _this$errorCallback4.call(this, 'WAV file header not available');
      return;
    }
    ...
    this.streamInterval = setInterval(() => {
      ...
      try {
        ...
        (_this$errorCallback5 = this.errorCallback) === null || _this$errorCallback5 === void 0 || _this$errorCallback5.call(this, errorMessage);
        this.stop();
      }
    }, intervalMs);
  }
  ...
  log(message) {
    ...
    (_this$options$logger = (_this$options = this.options).logger) === null || _this$options$logger === void 0 || _this$options$logger.call(_this$options, `[SimulateFileAudioStreamAdapter] ${message}`);
  }
}
